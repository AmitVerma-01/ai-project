const AI_projects = [
    {
        ...
        importance : {
            ...
            list : [
                {"Healthcare Providers" : "Assists in quicker diagnosis and treatment planning."},
                {"Patients": "Enables early-stage lung cancer detection, increasing survival rates and improving treatment success."},
                {"Medical Researchers":"Provides insights into factors contributing to lung cancer, aiding further medical research."}
            ],
    ...
    },
    {
        ...
        introduction : "Skin cancer is one of the most common types of cancer, and early detection is crucial for effective treatment. With the advancements in machine learning, predictive models are now being used to detect skin cancer at an early stage using image-based data. These models can analyze skin lesions and differentiate between malignant and benign forms of skin cancer.",
    ...
    },
    {
        ...
        price : 299,
        image : "/fakeUrl.jpg",
        introduction : "Fake URL detection is essential to combat phishing, fraud, and malicious websites that trick users into sharing sensitive information. Cybercriminals create fake URLs that mimic legitimate websites, making it crucial to identify and block such URLs to ensure online safety.",
        ...
        importance : {
            list : [
                {
                    "Feature Analysis": "Models analyze features like domain length, special characters, and URL structure to identify fake URLs."
                },{
                    "Supervised Learning": "Algorithms like Decision Trees and Random Forest are trained on datasets of legitimate and fake URLs for accurate classification."
                }
            ]
        },
        prediction: {
            details : "Fake URL detection using machine learning and NLP provides a powerful defense against phishing and online fraud. By analyzing URL features, these technologies help detect and block malicious websites, protecting users from potential cyber threats."
        }
    }
]
